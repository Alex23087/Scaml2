...
\begin{grammar}
  ...
  \altnl e~e \alt \slam b e \alt \sfix e \alt \sfixs e\alt \mathit{let}
  \altnl \sif e e e
  ...
  \\
  \\
  \mathit{let} \is \slet {\mathit{attr}{*}} b e e
  \altnl \texttt{let rec}~{\mathit{attr}{*}}~b = e~(\texttt{and}~\mathit{attr}{*}~b = e){*}~\texttt{in}~e
  \\
  \\
  ...
  \\
  d \is \sdlet {\mathit{attr}{*}} b e
  \altnl \sdletrec {\mathit{attr}{*}} b e~(\texttt{and}~d){*}
  \altnl \sexport x
  \\
  \\
  h \is \texttt{\{} (\mathit{op}~b+ = e\texttt{,}){*}~\texttt{return}~x = e \texttt{\}}
  \\
  \\
...
Values are tagged with labels, which belong to a lattice \(L\). \(L\) is itself
the product of the confidentiality and integrity lattices, \(I\) and \(C\), as
follows:
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	& C && I \\
	& {\mathrm{secret}^0} && {\mathrm{tainted}} \\
	{\mathrm{secret}^1_{}} & {\mathrm{secret}^n} & {\phantom{\mathrm{secret}^1_{}}} \\
	& {\mathrm{public}} && {\mathrm{untainted}}
	\arrow[""{name=0, anchor=center, inner sep=0}, from=2-4, to=4-4]
	\arrow[""{name=1, anchor=center, inner sep=0}, no head, from=3-1, to=2-2]
	\arrow["\cdots"{description}, draw=none, from=3-1, to=3-2]
	\arrow[""{name=2, anchor=center, inner sep=0}, no head, from=3-2, to=2-2]
	\arrow["\cdots"{description}, draw=none, from=3-2, to=3-3]
	\arrow[""{name=3, anchor=center, inner sep=0}, no head, from=3-3, to=2-2]
	\arrow[""{name=4, anchor=center, inner sep=0}, no head, from=4-2, to=3-1]
	\arrow[""{name=5, anchor=center, inner sep=0}, no head, from=4-2, to=3-2]
	\arrow[""{name=6, anchor=center, inner sep=0}, no head, from=4-2, to=3-3]
	\arrow["\cdots"{marking, allow upside down}, draw=none, from=1, to=2]
	\arrow["\cdots"{marking, allow upside down}, draw=none, from=3, to=2]
	\arrow["\times"{description, pos=0}, draw=none, from=3-3, to=0]
	\arrow["\cdots"{marking, allow upside down}, draw=none, from=4, to=5]
	\arrow["\cdots"{marking, allow upside down}, draw=none, from=5, to=6]
\end{tikzcd}\]
...
\begin{gather*}
  ...
  \\[4ex]\displaybreak[1]
  %
  \prftree[r]{[Lam]}{\bstep{\Delta}{pc}{\slam b e}{\vlam \Delta b e}{pc}} \\[1.5ex]\displaybreak[0]
  \prftree[r]{[Tuple]}
  ...
  {\prfStackPremises
    ...
    {p \triangleq \Delta(\mathrm{plugin}) \quad {\forall i \in [1,m].\; \ell_i \sqsubseteq \llbracket p; a_1^{i},\dots,a_{n}^{i} \rrbracket_{\mathrm{attr}}^{\top}}}
    {  {\valpair u_{i} \triangleq \langle v_i, \ell_i \sqcup  \llbracket p; a_1^{i},\dots,a_{n}^{i} \rrbracket_{\mathrm{attr}}^{\bot}\rangle} \quad
...
Initial environment \(\mathrm{plugin} \mapsto 0\)
