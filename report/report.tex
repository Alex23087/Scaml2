...
\begin{grammar}
  ...
  \altnl \sdeclassify e \alt \sendorse e
...
\begin{gather*}
  ...
  % TODO scrivere che assert si può implementare come funzione con securityexception quindi non ha senso restringerlo a contesti secret
  \prftree[r]{[Assert]}
