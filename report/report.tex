...
\begin{gather*}
  ...
  {\prfStackPremises
    ...
    \quad p \triangleq \Delta(\mathrm{plugin}) \quad \ell_1 \sqsubseteq \llbracket p; a_1,\dots,a_{n} \rrbracket_{\mathrm{attr}}^{\top}}
...
\begin{align*}
  \llbracket p; a_1,\dots,a_n \rrbracket_{\mathrm{attr}}^{\top,p} &= \bigsqcap_{i=1} \llbracket p; a_i \rrbracket_{\mathrm{attr}}^{\top} \qquad n \neq 1 \\
  \llbracket p; a_1,\dots,a_n \rrbracket_{\mathrm{attr}}^{\bot,p} &= \bigsqcup_{i=1} \llbracket p; a_i \rrbracket_{\mathrm{attr}}^{\bot} \qquad n \neq 1 \\
