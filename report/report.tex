...
\begin{gather*}
  ...
  {\bstep{\Delta}{pc}{\sfixs{e}}{\langle\valpair{v}_1, \dots, \valpair{v}_{n}\rangle}{pc \sqcup \ell \sqcup \bigsqcup_{i=1}^{n} \ell_{i} \sqcup \bigsqcup_{i=1}^{n} \ell_{i}'}}\\[4ex]\displaybreak[1]
  %
  \prftree[r]{[Let]}
...
TODO cambiare <> in [] per tuple semantica
