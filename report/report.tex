...
\begin{grammar}
  ...
  \\
  \tau \is \stint \alt \ststring \alt \stbool \alt \stfun \tau \tau \alt \stuple{\tau \scomma \dots \scomma \tau}
\end{grammar}
...
\begin{align*}
  \mathrm{Val} &= (\mathbb N \cup \mathrm{ASCII}^* \cup \left\{ \true, \false \right\} \cup \mathrm{Fun} \cup \mathrm{Val}^* \cup \mathrm{Defer} \cup \mathrm{Mod}) \times \mathrm{Lbl}
  \\
  \\
...
\begin{gather*}
  ...
  \\[2.5ex]\displaybreak[1]
  \prftree[r]{[Proj]}
  {\bstep{\Delta}{pc}{e_1}{\langle \langle v_j, \ell_{v_{j}} \rangle\rangle_{j \in [0,\dots,n-1]}}{\ell_1}}
  ...
  \qquad
  \prftree[r]{[Val]}{v \neq \slam x e}{\bstep{\Delta}{pc}{v}{\llbracket v \rrbracket}{pc}} \\[1.5ex]\displaybreak[0]
  %
  \prftree[r]{[App]}
  ...
  {\bstep{\Delta}{pc}{e_1~e_2}{u}{pc \sqcup \ell_{f} \sqcup \ell_{u}}} \\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[Uop]}
  ...
  {\bstep{\Delta}{pc}{e_1~\mathit{bop}~e_2}{\llbracket \mathit{bop} \rrbracket(v_1, v_2)}{pc \sqcup \ell_1 \sqcup \ell_2}} \\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[IfTrue]}
  ...
  {\bstep{\Delta}{pc}{\sif {e_{c}} {e_{t}} {e_{e}}}{v}{pc \sqcup \ell_c \sqcup \ell_e}} \\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[Fix]}
  ...
  {\prfStackPremises
    ...
    {\bstep{\Delta}{pc}{e}{\langle \overbrace{\langle\vlam {\Delta_i'} {x_{i}} {e_i'},\;{\ell_i}\rangle}^{f_{i}} \rangle_{i \in [1,n]}}{\ell}}
    ...
    {\forall i \in [1,n].\; \bste{\ext {\Delta_{i}'}{x_i}{\langle
          ...
          \langle \vdefer {\Delta''\hspace{-0.5em}} {(\sfixs \stuple{y_1 \scomma \dots \scomma y_{n}}).j},\; \ell_{j} \rangle_{j \in [1, n]}
          ,\; \ell_{i} \rangle}}{pc \sqcup \ell_{i}}{e_{i}'}{\smash{\overbrace{\langle v_{i},\; \ell_{i}' \rangle}^{\valpair v_{i}}}}}}
  {\bstep{\Delta}{pc}{\sfixs{e}}{\langle\valpair{v}_1, \dots, \valpair{v}_{n}\rangle}{pc \sqcup \ell \sqcup \bigsqcup_{i=1}^{n} \ell_{i} \sqcup \bigsqcup_{i=1}^{n} \ell_{i}'}}\\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[Let]}
  ...
  {\prfStackPremises
    {\bste{\Delta}{pc}{\sfixs{\stuple{
            ...
            \scomma \dots \scomma
            \slam {x_m} {e_m}}
        }}{\langle \langle \langle v_{i}, \ell_{i} \rangle \rangle_{i \in [1,m]} ,\; \ell \rangle}}
  ...
  {\bstep{\Delta}{pc}{\texttt{let rec}~{a_1^{1}~\dots~a_{n_{1}}^{1}}~x_{i} = {e_1}~(\texttt{and}~{a_1^{i}~\dots~a_{n_{i}}^{i}}~x_{i} = e_i)_{i \in [2,m]}~\texttt{in}~e}{v}{pc \sqcup \ell'}} \\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[Module]}
  ...
  {\bstep{\Delta}{pc}{\smodule {d_1 \dots d_{n}}}{\vmodule{\Delta'_{\mid \left\{ x \;\mid\; \sexport x \,\in\, \left\{ d_1,\dots,d_{n} \right\}\right\}}}}{pc}}\\[1.5ex]\displaybreak[1]
  %
  \prftree[r]{[TrustedModule]}
  % {\forall i \in [1, n].\; \bstep {\Delta} {pc} {d_i} {\partial_i} {\ell_i}}
  {\bstep{\Delta}{pc}{\llbracket d_1,\dots,d_{n} \rrbracket_{\mathrm{mod \to let}}}{\vlam {\Delta'} x x}{\ell}}
  {\bstep{\Delta}{pc}{\strusted {d_1 \dots d_{n}}}{\vtrusted{\Delta'_{\mid \left\{ x \;\mid\; \sexport x \,\in\, \left\{ d_1,\dots,d_{n} \right\}\right\}}}}{pc}}\\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[Plugin]}
  {\forall i \in [1, n].\; \bstep {\Delta} {pc} {d_i} {\partial_i} {\ell_i}}
  {\bstep{\Delta}{pc}{\splugin {d_1 \dots d_{n}}}{\vplugin{\partial_1 \dots \partial_n}}{pc}}\\[2.5ex]\displaybreak[1]
\end{gather*}
...
\begin{gather*}
  ...
  {y~\text{fresh}}
  {\bste{\Delta}{pc}{\sdo{op}{e_1~\dots~e_{n}}}{\langle op, \vlam \Delta y y, \langle \valpair v_1,\dots,\valpair v_{n} \rangle, pc \rangle}} \\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[HandleRet]}
  ...
  % {\bste{\Delta}{pc}{\shandle h e}{{\langle op', c', \langle \valpair v_1',\dots,\valpair v_{n}' \rangle, pc'' \rangle}}} \\[2.5ex]\displaybreak[1]
  %
  \prftree[r]{[BopRaiseL]}
