...
\newcommand*{\vdefer}[1]{\texttt{defer}~#1}
...
\begin{align*}
  \mathrm{Val} &= (\mathbb N \cup \mathrm{ASCII}^* \cup \left\{ \true, \false \right\} \cup \mathrm{Fun} \cup \mathrm{Defer} \cup \mathrm{Mod}) \times \mathrm{Lbl}
  \\
  \\
...
\begin{gather*}
  ...
  {\bstep{\Delta}{pc}{\vdefer e}{v}{\ell_2}}
  ...
  {\bste{\ext {\Delta'}{x}{\vdefer {\sfix {\vlam {\Delta'} x {e'}}}}}{pc \sqcup \ell}{e'}{\valpair v}}
  {\bste{\Delta}{pc}{\sfix e}{\valpair v}}\\[2.5ex]
  %
  \prftree[r]{[Module]}
  {\bste{\Delta}{pc}{\smodule {d_1 \dots d_{n}}}{}}\\[2.5ex]
\end{gather*}


Strict mode Let sempre \(\top\).
