...
\begin{gather*}
  ...
  \prftree[r]{[LetRecAnd]}
  {\prfStackPremises
    {\mathit{xs} \text{ fresh} \quad \mathrm{wrap}(e') \triangleq \slam{\mathit{xs}}{(\slet {\!\!} {x_i} {\sproj {\mathit{xs}} {i-1}} {\!\!}})_{i \in [1,m]}~e'}
  ...
  {\prfStackPremises
    ...
    {l_{C} = \mathrm{secret}^{p} \Rightarrow \Delta(\mathrm{plugin}) \in \left\{ 0, p \right\}}}
